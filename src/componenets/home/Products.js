    ...
    <div className='max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 xl:gap-10'>
      {
        productData.map((items) =>(
            <div key={items.id} className='bg-white h-auto border-[1px] py-8 z-30 hover:border-transparent shadow-none hover:shadow-textShadow duration-200 relative flex flex-col gap-4'>
                ...
                <img className="w-52 h-64 object-contain" src={items.image} alt="Product Image" />
                ...
                <div className='px-4 z-10 bg-white'>
                    <div className='flex items-center justify-between'>
                        <h2 className='font-titleFont tracking-wide text-lg text-amazon_light font-medium'>{items.title.substring(0,20)}</h2>
                        <p className='text-sm text-gray-600 font-semibold'>${items.price}</p>
                    </div>
                    <div>
